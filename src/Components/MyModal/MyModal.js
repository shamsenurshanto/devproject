...
function MyModal(props) {
    ...
    const url9 =`https://smoggy-toad-fedora.cyclic.app/api/transaction/createdtransactions`;
     ...
     const [MymodalUsedId,setMymodalUsedId] = useState(Id);
    ...
    // useEffect(()=>{
    //     setMymodalUsedId(Id)
    //     console.log(MymodalUsedId)
    // },[])
    const handleShow = () => {
       
        setShow(true);
        console.log(MymodalUsedId+" "+Id)
        const add2 = async () => {
  ...
  console.log(" " + MymodalUsedId + " " + Mail);
